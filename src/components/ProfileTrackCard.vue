...
const downloadTrack = () => {
    ...
    link.href = props.track.audio_url; // Asegúrate de que la URL sea accesible y correcta.
    link.setAttribute('download', downloadFileName.value); // Usa setAttribute por claridad.
