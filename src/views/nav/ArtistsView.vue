<template>
  ...
  <!-- Sección donde se muestran los artistas -->
  <div class="artists-section">
    ...
    <transition-group name="fade" tag="div" class="artists-container" appear>
      <div v-for="user in filteredUsers" :key="user.id" @click="goToProfile(user.nickname)" class="artist-profile"
        title="Ir al perfil">
...
// Computed para obtener las provincias de los usuarios
const provinces = computed(() => {
  const allProvinces = usersStore.users.map(user => user.province);
  return Array.from(new Set(allProvinces));
});

// Computed para filtrar a los usuarios por su provincia
