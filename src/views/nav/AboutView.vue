    ...
    <div class="about-container">
        <div class="about-item">
            <div class="description">
                ...
                donde los artistas emergentes puedan mostrar sus producciones al mundo y conectar con una audiencia global. <br>
                ...
                ¡Juntos, podemos construir un futuro donde el talento verdadero y la pasión por la música sean celebrados y apoyados!
            </div>
        </div>
        <div class="about-item">
